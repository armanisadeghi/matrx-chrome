    ...
    <div className="w-[360px] max-h-[500px] flex flex-col bg-[var(--m-bg-page)]">
      ...
      <header className="flex items-center justify-between px-4 py-2.5 bg-[var(--m-bg-card)] border-b border-[var(--m-border)]">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-[var(--m-radius-md)] bg-[var(--m-brand)] flex items-center justify-center shrink-0">
            <span className="text-white font-bold" style={{ fontSize: '12px' }}>M</span>
          </div>
          <div>
            <h1 className="font-semibold text-[color:var(--m-text-primary)] leading-tight" style={{ fontSize: '14px' }}>
              Matrx
            </h1>
            <p className="text-[color:var(--m-text-tertiary)]" style={{ fontSize: '10px', lineHeight: '14px' }}>
      ...
      {tab && (
        <div className="flex items-center gap-2 px-4 py-1.5 bg-[var(--m-bg-inset)] border-b border-[var(--m-border)]">
          <Globe className="w-3.5 h-3.5 text-[color:var(--m-text-tertiary)] shrink-0" />
      ...
      <div className="flex-1 overflow-auto p-4 flex flex-col gap-3">
        ...
        <Card>
          <CardBody>
            <h2 className="font-semibold text-[color:var(--m-text-primary)] mb-2.5" style={{ fontSize: '12px' }}>
              Quick Extract
            </h2>
            <ExtractionPanel />
          </CardBody>
        ...
        {/* Open Full UI */}
        <Button variant="secondary" size="lg" block onClick={openSidePanel}>
