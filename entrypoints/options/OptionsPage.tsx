...
export function OptionsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetchUserProjects(), getLocal<string>(STORAGE_KEY_PROJECT)])
  ...
  return (
    <div className="min-h-screen bg-[var(--m-bg-page)]">
      <div className="w-full flex flex-col gap-5">
        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1
              className="font-bold text-[color:var(--m-text-primary)]"
              style={{ fontSize: "18px", lineHeight: "22px" }}
            >
              Matrx Settings
            </h1>
            <p
              className="text-[color:var(--m-text-secondary)]"
              style={{ fontSize: "12px" }}
            >
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 px-3 py-2.5 bg-[var(--m-bg-inset)] rounded-[var(--m-radius-md)]">
                  <div className="w-9 h-9 rounded-full bg-[var(--m-brand-subtle)] flex items-center justify-center shrink-0">
                    <span
                      className="text-[var(--m-brand)] font-semibold"
                      style={{ fontSize: "15px" }}
                    >
                  ...
                  <div className="min-w-0">
                    <p
                      className="font-medium text-[color:var(--m-text-primary)] truncate"
                      style={{ fontSize: "13px" }}
                    >
                      {user?.email}
                    </p>
                    <p
                      className="text-[color:var(--m-text-tertiary)]"
                      style={{ fontSize: "11px" }}
                    >
          ...
          <Card elevated>
            ...
            <CardBody>
              <div className="flex flex-col gap-2">
                <label
                  className="font-medium text-[color:var(--m-text-primary)]"
                  style={{ fontSize: "12px" }}
                >
                  Project
                </label>
                {loadingProjects ? (
                  <div
                    className="flex items-center gap-2 text-[color:var(--m-text-tertiary)]"
                    style={{ fontSize: "12px" }}
                  >
        ...
        {/* Version */}
        <p
          className="text-center text-[color:var(--m-text-tertiary)] mt-1"
          style={{ fontSize: "11px" }}
        >
